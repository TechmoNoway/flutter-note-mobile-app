...
import 'package:note_flutter/utils/dialogs/password_reset_email_sent_dialog.dart';
        ...
        if (state is AuthStateForgotPassword) {
          ...
          if (state.exception != null) {
            await showErrorDialog(
              context,
              "We could not process your request. Please make that you are a registered user.",
            );
          }
        }
      },
